...
X_train = pd.read_csv('./example/UCI/UCI_dataset_backup/X_train.csv')
X_train = df_to_cuda(X_train)

X_train_raw = pd.read_csv('./example/UCI/UCI_dataset_backup/X_train_unscaled.csv')
X_train_raw = df_to_cuda(X_train_raw)

X_test = pd.read_csv('./example/UCI/UCI_dataset_backup/X_test.csv')
...
# # torch.save(clf, "models/saved/UCI_retrained_GS.pt")
...
pd.DataFrame(cf_list).to_csv('./example/GS_example/UCI_cf.csv', index = False)
pd.DataFrame(X_test).to_csv('./example/GS_example/UCI_X.csv', index = False)
