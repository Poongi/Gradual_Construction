...
def minmax_unscaler(X):
    max_list = pd.read_csv('./datasets/UCI_dataset_backup/X_train_scale_max.csv')
    min_list = pd.read_csv('./datasets/UCI_dataset_backup/X_train_scale_min.csv')
...
path_data = '/home/heedong/Documents/LORE_copy/datasets/'
...
dataset_name = 'UCI_Credit_Card.csv'
dataset = prepare_UCI_dataset(dataset_name, path_data)
...
device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
blackbox = torch.load("./models/UCI_retrained.pt")
...
for i in range(nbr_evaluates) : 
    ...
    with open('./datasets/LORE_UCI_results/target_X.pickle', 'wb') as f:
        pickle.dump(array_target, f)

    with open('./datasets/LORE_UCI_results/target_cf.pickle', 'wb') as f:
        pickle.dump(array_cf, f)

    with open('./datasets/LORE_UCI_results/target_explanation.pickle', 'wb') as f:
        pickle.dump(array_explain, f)

    with open('./datasets/LORE_UCI_results/UCI_features_name', 'wb') as f:
        pickle.dump(array_features_name, f)
    
    print("number of experiments : ", i)
...
# with open('./datasets/LORE_UCI_results/target_X.pickle', 'rb') as f:
#     load_X = pickle.load(f)

# with open('./datasets/LORE_UCI_results/target_cf.pickle', 'rb') as f:
#     load_cf = pickle.load(f)

# with open('./datasets/LORE_UCI_results/target_explanation.pickle', 'rb') as f:
#     load_explanation = pickle.load(f)

# with open('./datasets/LORE_UCI_results/UCI_features_name', 'rb') as f:
