...
# def gradual_conscruction(i) :
        ...
        parser.add_argument('--dataset', type=str, default="UCI", help="choice: ['mnist','imdb','heloc']")
        parser.add_argument('--data_path', type=str, default="./example/UCI/UCI_test_set/test"+str(i)+".csv", help='input data path')
        # parser.add_argument('--data_path', type=str, default="./example/UCI/UCI_test_set_noised/test"+str(i)+".csv", help='input data path')
        parser.add_argument('--l2_coeff', type=float, default=5, help='coefficient of the l2 regularization')
        ...
        parser.add_argument('--target_prob', type=float, default=0.1,help='target probability of the target class')
        parser.add_argument('--d', type=int, default='1',help='determine size of mask')
        parser.add_argument('--model_path', type=str, default='./models/saved/UCI_retrained.pt',
        ...
        dataset_dict={
                ...
                'UCI' : {'CF_method':'Expl_tabular',\
                        'ref_path': './ref_data/UCI_ref/',\
                        'saved_path':'./result/UCI/'},\
                        # 'saved_path':'./result/UCI_stability_results/'},\
                }
