...
# def gradual_conscruction(i) :
        ...
        parser.add_argument('--dataset', type=str, default="heloc", help="choice: ['mnist','imdb','heloc']")
        parser.add_argument('--data_path', type=str, default="./example/HELOC/heloc_test_set/test"+str(i)+".csv", help='input data path')
        ...
        parser.add_argument('--model_path', type=str, default='./models/saved/HELOC_retrained.pt',
