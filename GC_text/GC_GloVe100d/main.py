...
for iter in range(1000):
        ...
        #     parser.add_argument('--data_path', type=str, default="./example/IMDB/1.txt", help='input data path')
        parser.add_argument('--data_path', type=str, default="./example/IMDB/review_"+str(iter)+".txt", help='input data path')
        ...
        parser.add_argument('--n_iter', type=int, default=700, help='iteration number')
        ...
        parser.add_argument('--model_path', type=str, default='./models/saved/tut4-model_300.pt',
        ...
        mask_num = CF_expl.run()




        mask_list.append(mask_num)
        print('**********************'*5)
        print('L1 mean \t:', np.mean(np.array(mask_list)))
        print('L1 std\t:', np.std(np.array(mask_list)))
        print('nbr_iter : ', iter)
        print('**********************'*5)